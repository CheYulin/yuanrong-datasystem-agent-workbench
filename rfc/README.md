...
|------|-----|--------|-----------------------|
| 2026-08-10 | [2026-08-10-two-worker-active-isolation/](2026-08-10-two-worker-active-isolation/README.md) | **In-Progress** | 两 Worker 单 reporter 无法触发 3s 主动隔离；增加 Coordinator 直接 probe 双证据确认，并补 V=0 锚点与 UT/ST 看护 |
