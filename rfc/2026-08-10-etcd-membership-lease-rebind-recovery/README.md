...
| 源码基线 | `v0.9.2.rc12` (`00c31da53a08`)，并与 `main/master` (`d0de0540fcda`) 交叉核对 |
...
本 RFC 采用 TDD + SDD：先用必要 UT、focused ST 和 cluster ST 稳定复现，再做最小源码修复。修复不放宽
...
| Focused ST | `tests/st/common/kvstore/etcd_store_test.cpp` | 看护 lease rebind 仍先发布 RECOVERING |
